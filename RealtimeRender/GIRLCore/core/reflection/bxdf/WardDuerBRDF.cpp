...
//	Date    :	Modifications
//	=========================== 
//	2008-10-04  :   First version - WardDuerBRDF.cpp initial implementation
//
...
void WardDuerBRDF::f(const TsPack *tspack, const Vector &_wo, const Vector &_wi, SWCSpectrum *const f) const
{
   ...
   *f += Ks * 1.f / (cosThetaI*cosThetaO)  * exp( -tan2ThetaH * (cos2PhiH * INV_Ax2 + sin2PhiH * INV_Ay2 ) ) * INV_4PI_AxAy;
}

float WardDuerBRDF::Pdf(const TsPack *tspack, const Vector &_wo, const Vector &_wi) const
...
bool WardDuerBRDF::Sample_f(const TsPack *tspack, const Vector &wo, Vector *wi,
