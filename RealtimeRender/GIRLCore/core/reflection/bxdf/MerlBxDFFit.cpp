...
//	Date    :	Modifications
//	=========================== 
//	2008-10-04  :   First version - MerlBxDFFit.cpp initial implementation
//
...
void MerlBxDFFit::f(const TsPack *tspack, const Vector &wo, const Vector &wi, SWCSpectrum *const f) const
{
