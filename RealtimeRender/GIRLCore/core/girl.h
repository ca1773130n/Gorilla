...
//	Date    :	Modifications
//	=========================== 
//	2008-10-04  :   First version - girl.h initial implementation
//
...
#ifdef GIRLCORE_SOURCE
#define GIRLCOREDLL __declspec(dllexport)
#else
#define GIRLCOREDLL __declspec(dllimport)
#endif
...
#endif
#define GIRL_VERSION 0.5
#define GIRL_VERSION_STRING "0.5 (CVS)"
#define RAY_EPSILON 1e-3f
#define SHADOW_RAY_EPSILON 1e-4f
#define COLOR_SAMPLES 3
#if defined(WIN32) && !defined(__CYGWIN__)
#  define GIRL_PATH_SEP ";"
#else
#  define GIRL_PATH_SEP ":"
#endif
...
extern "C" GIRLCOREDLL bool ParseFile(const char *filename);
namespace girl
{
