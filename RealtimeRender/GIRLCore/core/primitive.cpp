...
{
	girlError(GIRL_BUG,GIRL_SEVERE,"Unimplemented Primitive::Refine method called!");
}


bool Primitive::Intersect(const Ray &r, Intersection *in) const {
	girlError(GIRL_BUG,GIRL_SEVERE,"Unimplemented Primitive::Intersect method called!");
	return false;
}
bool Primitive::IntersectP(const Ray &r) const {
	girlError(GIRL_BUG,GIRL_SEVERE,"Unimplemented Primitive::IntersectP method called!");
	return false;
}
...
{
	girlError(GIRL_BUG,GIRL_SEVERE,"Unimplemented Primitive::GetShadingGeometry method called!");
}


float Primitive::Area() const {
	girlError(GIRL_BUG,GIRL_SEVERE,"Unimplemented Primitive::Area method called!");
	return 0.f;
}
Point Primitive::Sample(float u1, float u2, float u3, Normal *Ns) const {
	girlError(GIRL_BUG,GIRL_SEVERE,"Unimplemented Primitive::Sample method called!");
	return Point();
}
