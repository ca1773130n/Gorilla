...
//	Date    :	Modifications
//	=========================== 
//	2009-07-07  :   First version - qbvhaccel.cpp initial implementation
//
...
//	nodes = AllocAligned<QBVHNode>(2 * nPrims - 1);
	nodes = (QBVHNode *)AllocAligned((2 * nPrims - 1) *	sizeof(QBVHNode));
...
//	prims = AllocAligned<boost::shared_ptr<Primitive> >(4 * nQuads);
	prims = (boost::shared_ptr<Primitive>*)AllocAligned((4 * nQuads) *
