...
//	Date    :	Modifications
//	=========================== 
//	2008-10-04  :   First version - MerlWardDuer.h initial implementation
//
...
namespace girl
{
	class GIRLCOREDLL  MerlWardDuer : public Material {
	public:
		// MerlWardDuer Public Methods
		MerlWardDuer(
			const string &name,
