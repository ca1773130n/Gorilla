...
//	Date    :	Modifications
//	=========================== 
//	2008-10-04  :   First version - environment.cpp initial implementation
//
...
void EnvironmentCamera::GetFgirl2RadianceFactors(Film *film, float *factors, int xPixelCount, int yPixelCount) const
{
