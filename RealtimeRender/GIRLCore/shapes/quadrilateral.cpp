...
//	Date    :	Modifications
//	=========================== 
//	2008-10-04  :   First version - quadrilateral.cpp initial implementation
//
...
BBox QuadMesh::ObjectBound() const {
	girlError(GIRL_BUG,GIRL_SEVERE, "Unimplemented QuadMesh::ObjectBound() method called");
	return BBox();
}


// Quadrilateral Method Definitions
Quadrilateral::Quadrilateral(const girl::Transform &o2w, bool ro, 
