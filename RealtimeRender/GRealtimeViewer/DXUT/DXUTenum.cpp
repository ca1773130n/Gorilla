                                          ...
                                          DXUTMatchOptions* pMatchOptions )
{
    ...
    {
        // Default to no multisampling 
        pOptimalDeviceSettings->sd.SampleDesc.Count = 8;
        pOptimalDeviceSettings->sd.SampleDesc.Quality = 8;
    }
    else
    {
        pOptimalDeviceSettings->sd.SampleDesc.Count = 4;//pDeviceSettingsIn->sd.SampleDesc.Count;
        pOptimalDeviceSettings->sd.SampleDesc.Quality = 2;//pDeviceSettingsIn->sd.SampleDesc.Quality;
    }
    ...
    if( pMatchOptions->ePresentInterval == DXUTMT_IGNORE_INPUT )
    {
        ...
        pOptimalDeviceSettings->SyncInterval = 0;
    }
    else
    {
                                        ...
                                        DXUTMatchOptions* pMatchOptions )
{
    ...
    else if( pMatchOptions->ePresentInterval == DXUTMT_IGNORE_INPUT )
    {
        ...
        // anything but 0.
        bestPresentInterval = 0;//( D3D10_DRIVER_TYPE_REFERENCE == pBestDeviceSettingsCombo->DeviceType ) ? 0 : 1;
    }
    else // if( pMatchOptions->ePresentInterval == DXUTMT_CLOSEST_TO_INPUT )
    {
        bestPresentInterval = pDeviceSettingsIn->SyncInterval;
