...
public:
	...
	void SetViewMatrix( D3DXMATRIX matView ) { m_mView = matView; }
	void SetProjMatrix( D3DXMATRIX matProj ) { m_mProj = matProj; }
...
public:
    ...
    const D3DXVECTOR3* GetWorldRight() const { return (D3DXVECTOR3*)&m_mWorld._11; } 
    const D3DXVECTOR3* GetWorldUp() const    { return (D3DXVECTOR3*)&m_mWorld._21; }
    const D3DXVECTOR3* GetWorldAhead() const { return (D3DXVECTOR3*)&m_mWorld._31; }
    const D3DXVECTOR3* GetEyePt() const      { return (D3DXVECTOR3*)&m_mWorld._41; }

	void SetWorldMatrix( D3DXMATRIX matWorld ) { m_mWorld = matWorld; }

protected:
    D3DXMATRIX m_mWorld;       // World matrix of the camera (inverse of the view matrix)
