...
# 3D Texture
class GraniteTexture(OpenMayaMPx.MPxNode, TextureNode):
    ...
    def __init__(self):
        ...
        self.attributes['color3']   = TextureColorAttribute('color3',  self.addToOutput, self.prependToOutput)
        ...
        self.attributes['mixRatio']  = TextureFloatAttribute('mixRatio', self.addToOutput, self.prependToOutput)
